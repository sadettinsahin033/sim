...
namespace Gley.PedestrianSystem
{
    ...
    public class StopAtCrossing : PedestrianBehaviour
    {
        ...
        public override void Initialize(Animator characterAnimator, int pedestrianIndex, int priority)
        {
        ...
        public override void Execute(float turnAngle, float walkSpeed)
        {
        ...
        private void PedestrianIsAtCrossing(int pedestrianIndex, List<IIntersection> intersection, int waypointIndex)
        {
