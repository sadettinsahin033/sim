...
namespace Gley.PedestrianSystem
{
    ...
    /// </summary>
    public class AllPedestrians :IDestroyable
    {
        ...
        internal bool HasExternalWaypointSelectionMethod(int pedestrianIndex)
        {
            if(IsPedestrianIndexValid(pedestrianIndex))
            {
                return _allPedestrians[pedestrianIndex].HasExternalWaypointSelectionMethod;
            }
            return false;
        }
        #endregion
