...
namespace Gley.PedestrianSystem
{
    public static class API
    {
        ...
        public static PedestrianWaypoint GetWaypointFromIndex(int waypointIndex)
        {
#if GLEY_PEDESTRIAN_SYSTEM
        ...
        {
#if GLEY_PEDESTRIAN_SYSTEM
            PedestrianManager.Instance.DensityManager?.RemovePedestrian(pedestrianIndex, true);
#endif
        }
        ...
        /// <summary>
        /// Prevents the removal of a pedestrian at the specified index by the pooling system.
        /// </summary>
        /// <param name="pedestrianIndex">The index of the pedestrian whose removal behavior is being modified.</param>
        /// <param name="dontRemove">A value indicating whether the pedestrian should not be removed.</param>
        public static void DontRemovePedestrian(int pedestrianIndex, bool dontRemove)
        {
#if GLEY_PEDESTRIAN_SYSTEM
            PedestrianManager.Instance.WaypointManager?.GetMovementParams()[pedestrianIndex].DontRemovePedestrian(dontRemove);
#endif
        }
        #endregion
        ...
        internal static UrbanSystem.GridData GetGridDataHandler()
        {
#if GLEY_PEDESTRIAN_SYSTEM
