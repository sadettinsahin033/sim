...
namespace Gley.PedestrianSystem
{
    ...
    public class Pedestrian : MonoBehaviour, IColliderRemovalListener
    {
        ...
        [SerializeField][HideInInspector] private UrbanSystem.VisibilityScript _visibilityScript;
...
#pragma warning restore CS0414
        ...
        public bool HasExternalWaypointSelectionMethod { get; internal set; }
        ...
        {
            ColliderRemovalRegistry.Trigger(_allColliders);
        }
