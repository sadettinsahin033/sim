...
namespace Gley.PedestrianSystem
{
    ...
    /// </summary>
    public class StreetCrossingComponent : MonoBehaviour, IIntersection
    {
        ...
        public void SetComponentWaypoints(int[] allWaypoints)
        {
            _intersectionWaypoints = allWaypoints;
        }

        public List<PedestrianWaypointSettings> GetStopWaypoints()
        {
        ...
        public void SetStopWaypointsState(bool stop)
        {
            ...
            {
                SharedPedestrianEvents.TriggerStopStateChangedEvent(_intersectionWaypoints[i], stop);
            }
        }
