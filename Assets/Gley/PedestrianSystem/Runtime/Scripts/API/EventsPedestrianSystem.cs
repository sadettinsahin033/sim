...
namespace Gley.PedestrianSystem
{
    public class Events
    {
        ...
        public delegate void StreetCrossing(int pedestrianIndex, List<UrbanSystem.IIntersection> intersection, int waypointIndex);
        public static StreetCrossing OnStreetCrossing;
        public static void TriggerStreetCrossingEvent(int pedestrianIndex, List<UrbanSystem.IIntersection> intersection, int waypointIndex)
        {
