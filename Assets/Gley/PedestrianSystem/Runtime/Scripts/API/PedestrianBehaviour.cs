...
namespace Gley.PedestrianSystem
{
    ...
    { 
        ...
        public abstract void Execute(float turnAngle, float moveSpeed);
        ...
        public virtual void Initialize(Animator characterAnimator, int pedestrianIndex, int priority)
        {
