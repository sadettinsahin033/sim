...
namespace Gley.PedestrianSystem
{
    ...
    public class PedestrianWaypoint : Waypoint
    {
        ...
        [SerializeField] private List<IIntersection> _associatedIntersection;
        ...
        public List<IIntersection> AssociatedIntersection => _associatedIntersection;
        ...
        {
            if(_associatedIntersection == null)
            {
                _associatedIntersection = new List<IIntersection>();
            }
            _associatedIntersection.Add(associatedIntersection);
        }
    }
}
