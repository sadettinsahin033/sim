...
using UnityEngine;
using GleyPrefabUtilities = Gley.UrbanSystem.Editor.GleyPrefabUtilities;

namespace Gley.PedestrianSystem.Editor
{
    public class PedestrianWaypointEditorData : UrbanSystem.Editor.EditorData
    {
        ...
        public override void LoadAllData()
        {
            ...
            for (int i = 0; i < _allWaypoints.Length; i++)
            {
                ...
                if (_allWaypoints[i].neighbors.Count == 0 && _allWaypoints[i].prev.Count < 2)
                {
