...
{
    internal class PedestrianLaneDrawer : UrbanSystem.Editor.Drawer
    {
        ...
        private void DrawSingleLane(UrbanSystem.Editor.LaneHolder<PedestrianWaypointSettings> laneHolder, Color waypointColor, Color disconnectedColor)
        {
            Vector3[] positions;
