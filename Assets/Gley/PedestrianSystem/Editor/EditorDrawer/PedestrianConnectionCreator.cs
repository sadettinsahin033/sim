    ...
    internal class PedestrianConnectionCreator
    {
        ...
        private void AddLaneConnectionWaypoints(PedestrianConnectionCurve connection, float waypointDistance, float laneWidth)
        {
            ...
            while (t < 1)
            {
                ...
                if (t < 1)
                {
                    var waypointName = roadName + "-" + UrbanSystemConstants.LaneNamePrefix + 0 + "-" + UrbanSystemConstants.ConnectionWaypointName + (++nr);
            ...
            //set names
            connectorWaypoints[0].name = roadName + "-" + UrbanSystemConstants.LaneNamePrefix + 0 + "-" + UrbanSystemConstants.ConnectionEdgeName + nr;
            connectorWaypoints[connectorWaypoints.Count - 1].name = roadName + "-" + UrbanSystemConstants.LaneNamePrefix + 0 + "-" + UrbanSystemConstants.ConnectionEdgeName + (connectorWaypoints.Count - 1);
