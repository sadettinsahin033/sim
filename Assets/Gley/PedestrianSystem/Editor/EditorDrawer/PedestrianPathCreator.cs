...
{
    internal class PedestrianPathCreator : UrbanSystem.Editor.RoadCreator<PedestrianPath, PedestrianConnectionPool, PedestrianConnectionCurve>
    {
        public PedestrianPathCreator(UrbanSystem.Editor.RoadEditorData<PedestrianPath> data) : base(data)
        {
        }
