...
namespace Gley.PedestrianSystem.Editor
{
    ...
    internal class PedestrianEditor : UnityEditor.Editor
    {
        ...
        {
            var layerSetup = FileCreator.LoadScriptableObject<LayerSetup>(PedestrianSystemConstants.LayerPath);
        ...
        private void SetupAnimator(Pedestrian targetScript, ref bool correct)
        {
            ...
            if (!HasAnimatorParameter(anim, PedestrianSystemConstants.AnimatorAngleID))
            {
                LogError(ref correct, $"Animator of {targetScript.name} does not define the a Float parameter named {PedestrianSystemConstants.AnimatorAngleID}. This is required.");
                return;
            }

            if (!HasAnimatorParameter(anim, PedestrianSystemConstants.AnimatorSpeedID))
            {
                LogError(ref correct, $"Animator of {targetScript.name} does not define the a Float parameter named {PedestrianSystemConstants.AnimatorSpeedID}. This is required.");
                return;
            }
