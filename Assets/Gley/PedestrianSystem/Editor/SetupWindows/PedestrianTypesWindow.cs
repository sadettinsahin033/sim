...
namespace Gley.PedestrianSystem.Editor
{
    public class PedestrianTypesWindow : SetupWindowBase
    {
        ...
        private void Save()
        {
            FileCreator.CreateAgentTypesFile<PedestrianTypes>(_pedestrianCategories, PedestrianSystemConstants.GLEY_PEDESTRIAN_SYSTEM, PedestrianSystemConstants.PedestrianNamespaceUser,PedestrianSystemConstants.AgentTypesPath);
        }
