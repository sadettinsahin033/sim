...
namespace InsaneSystems.RoadNavigator
{
	...
	public class MapScreenCamera : MonoBehaviour
	{
		...
		public Rect outMapRect { get; private set; }

		Map map;
		
		public float GetMapAspect() => map.RealMapScale.x / map.RealMapScale.y;

		public float GetScreenAspect() => Screen.width / (float)Screen.height;
		...
		static void DumpRenderTexture(Camera cam, RenderTexture rt, string pngOutPath)
		{
