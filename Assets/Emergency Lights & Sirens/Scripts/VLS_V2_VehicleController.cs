    ...
    public class VLS_V2_VehicleController : MonoBehaviour
    {
        ...
        ***********************************/
        ...
        void Start()
        {
            ...
            // [DEĞİŞİKLİK] - Tüm ışıkları kapatmak yerine direkt maksimum moda alıp sistemi başlatıyoruz.
            ...
            // Çakar döngüsünü otomatik olarak tetikliyoruz
            StartCoroutine(Run());
        }
        ...
        {
            {
                ...
                // [DEĞİŞİKLİK] - J Tuşu (LightsKey) kontrolü tamamen kaldırıldı. 
                // Sirenler artık kapatılamaz ve hep maksimumda kalır.
        ...
        public void SetDirectionalPattern(int i)
        {
            ...
            if (DirectionalController == null)
                return;
            if (BeepSource != null) { BeepSource.Stop(); BeepSource.Play(); }
